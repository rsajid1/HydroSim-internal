...
### Known follow-ups
- Stress score caps ~66% because the engine weights 8 fields but the UI sends only 5 — normalize the score over the fields actually provided so extreme inputs reach ~100% stress / ~0% yield.
